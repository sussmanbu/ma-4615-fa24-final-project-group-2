...
plot1 <- ggplot(traffic_data, aes(x = driver_race, fill = driver_race)) +
  geom_bar() +
...
plot2 <- ggplot(traffic_data, aes(x = driver_race, fill = stop_outcome)) +
...
plot3 <- ggplot(traffic_data, aes(x = as.Date(stop_date))) +
...
plot4 <- ggplot(traffic_data, aes(x = violation, fill = driver_race)) +
...
plot5 <- ggplot(traffic_data, aes(x = driver_race, fill = stop_duration)) +
  geom_bar(position = "fill") +
...
plot6 <- ggplot(traffic_data, aes(x = driver_race, fill = search_conducted)) +
  geom_bar(position = "fill") +
...
plot7 <- ggplot(traffic_data, aes(x = violation, fill = violation)) +
  geom_bar() +
...
plot8 <- ggplot(traffic_data, aes(x = driver_race, fill = drugs_related_stop)) +
  geom_bar(position = "fill") +
...
plot9 <- ggplot(traffic_data, aes(x = driver_race, fill = stop_outcome)) +
  geom_bar(position = "fill") +
...
plot10 <- ggplot(traffic_data, aes(x = district, fill = driver_race)) +
  geom_bar(position = "fill") +
